...
predCoords = spawnPredators(10, 1.1);
newPredCoords = [];
...
predIntervals = predInts(B, newPredCoords, rho2);
...
%dirTest = (direction+directionAwayFromPredators)./2;

%Calculates the new coordinates for the fish
newCoords(i,:) = 1*(.15*direction + .05*(directionAwayFromPredators)) + coords(i,:);
